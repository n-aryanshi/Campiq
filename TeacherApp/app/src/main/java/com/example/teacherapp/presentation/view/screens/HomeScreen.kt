...
import com.example.teacherapp.ui.theme.Green
    ...
    Box(
        ...
        Column(
            ...
            Box(
                ...
                Image(
                    painter = painterResource(R.drawable.rect_home_bg2),
...
fun GridBody() {
    val items = listOf(
        GridItem(painterResource(R.drawable.calendr_icon), "Attendance", Color(0xFFFDF7EE)),
        GridItem(painterResource(R.drawable.class_icon), "Class", Color(0xFFFAF1F8)),
        GridItem(painterResource(R.drawable.alarm_icon), "Time Table", Color(0xFFFFE9D6)),
        GridItem(painterResource(R.drawable.email_icon), "Notices", Color(0xFFE9F4F2)),
        GridItem(painterResource(R.drawable.locate_icon), "Room", Color(0xFFE3F2FD)),
        GridItem(painterResource(R.drawable.book_icon), "Diary", Color(0xFFFFEBEE))
    )
                ...
                TopAppBar(
                    ...
                    navigationIcon = {
                        IconButton(onClick = { scope.launch { drawerState.open() } }) {
                            Icon(Icons.Default.Menu,tint = Color.Black, contentDescription = "Menu")
                        }
                    },
                    actions = {
                        IconButton(onClick = { /* handle notifications */ }) {
                            Icon(Icons.Default.Notifications,tint = Color.Black, contentDescription = "Notifications")
                        }
                    }
                )
            }
