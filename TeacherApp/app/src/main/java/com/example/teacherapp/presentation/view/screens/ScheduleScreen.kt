...
import com.example.teacherapp.ui.theme.ProtestStrike
...
fun TimeTableScreen(items: List<TimeTableItem>) {
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(LightGreen) // your teal background
    ) {
        // custom Top bar
        CustomTopBar(
            title = "Time Table",
...
fun TimeTableScreenPreview() {
    val sampleItems = listOf(
        TimeTableItem(1, "CSE Ist yr",  "9:00 AM - 9:45 AM"),
        TimeTableItem(2, "MCA Ist yr",  "9:50 AM - 10:35 AM"),
        TimeTableItem(3, "Mech. 3rd Yr",  "10:40 AM - 11:25 AM"),
        TimeTableItem(4, "ECE-AI 2nd Yr",  "9:00 AM - 9:45 AM"),
        TimeTableItem(5, "CSE Ist yr",  "9:50 AM - 10:35 AM"),
        TimeTableItem(6, "MCA Ist yr",  "10:40 AM - 11:25 AM"),
        TimeTableItem(7, "Mech. 3rd Yr", "9:00 AM - 9:45 AM"),
        TimeTableItem(8, "ECE-AI 2nd Yr",  "9:50 AM - 10:35 AM"),
